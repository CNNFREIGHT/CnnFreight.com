<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:43:"./application/admin/template/system/web.htm";i:1741228788;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756879123;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:69:"/www/wwwroot/cnnfreight.com/application/admin/template/system/bar.htm";i:1667356242;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="ncap-form-default">
                ...
                <div id="div_web_status_close" class="<?php if(!isset($config['web_status']) OR empty($config['web_status'])): ?>none<?php endif; ?>">
                    ...
                    <dl class="row dl_web_status_mode <?php if(empty($config['web_status_mode']) || 2 != $config['web_status_mode']): ?>none<?php endif; ?>" id="dl_web_status_mode_2">
                        ...
                        <dd class="opt">
                            <input id="web_status_tpl" name="web_status_tpl" value="<?php if(isset($config['web_status_tpl'])): ?><?php echo (isset($config['web_status_tpl']) && ($config['web_status_tpl'] !== '')?$config['web_status_tpl']:''); else: ?>https://www.cnnfreight.com/public/close.html<?php endif; ?>" class="input-txt" type="text" placeholder="关闭后，访问网站显示的个性化页面，public/close.html" autocomplete="off"/>
