<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./application/admin/template/seo/seo.htm";i:1756433208;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756433208;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:66:"/www/wwwroot/cnnfreight.com/application/admin/template/seo/bar.htm";i:1655708908;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page min-hg-c-10 atta">
        <div class="fixed-bar">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <?php if(!empty($global['web_citysite_open'])): ?>
                    <p class="notic2">你已开启城市分站，静态页面功能不可用</p>
                    <?php endif; ?>
                </dd>
            </dl>
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：https://www.cnnfreight.com/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：https://www.cnnfreight.com/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 3): ?>none<?php endif; ?>" id="dl_seo_rewrite_format">
                ...
                <dd class="opt">
                    <label class="curpoin">
                        <input type="radio" name="seo_rewrite_format" <?php if(!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1): ?> value="1" checked="checked" <?php else: ?> value="3" checked="checked" <?php endif; ?>>目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_1');">示例</a><span id="view_3_1" class="none">：https://www.cnnfreight.com/news/</span>）
                    </label>&nbsp;
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_rewrite_format" value="2" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 2): ?>checked="checked"<?php endif; ?>>模型标识（<a href="javascript:void(0);" onclick="view_exp('view_3_2');">示例</a><span id="view_3_2" class="none">：https://www.cnnfreight.com/article/news.html</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="seo_title_symbol">标题间连接符</label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 2): ?>none<?php endif; ?>" id="dl_seo_uphtml_editafter">
                <dt class="tit">
                    <label>编辑文档</label>
                </dt>
                <dd class="opt">
                    <label class="curpoin"><input type="checkbox" name="seo_uphtml_editafter_home" value="1" <?php if(!isset($config['seo_uphtml_editafter_home']) OR $config['seo_uphtml_editafter_home'] == 1): ?>checked="checked"<?php endif; ?>>更新首页</label>&nbsp;&nbsp;
                    <label class="curpoin"><input type="checkbox" name="seo_uphtml_editafter_channel" value="1" <?php if(!isset($config['seo_uphtml_editafter_channel']) OR $config['seo_uphtml_editafter_channel'] == 1): ?>checked="checked"<?php endif; ?>>更新相关栏目</label>&nbsp;&nbsp;
                    <label class="curpoin"><input type="checkbox" name="seo_uphtml_editafter_pernext" value="1" <?php if(!isset($config['seo_uphtml_editafter_pernext']) OR $config['seo_uphtml_editafter_pernext'] == 1): ?>checked="checked"<?php endif; ?>>更新上下篇</label>&nbsp;&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] == 2): ?>none<?php endif; ?>" id="dl_seo_uphtml_after13">
                <dt class="tit">
                    <label>发布/编辑文档</label>
                </dt>
                <dd class="opt">
                    <label class="curpoin <?php if($global['web_cmsmode'] != 1): ?>ey_auto_layer_tips grey<?php endif; ?>" data-layer_tips_txt='开启运营模式生效' data-layer_opt_tips='3'><input type="checkbox" name="seo_uphtml_after_home13" value="1" <?php if(!isset($config['seo_uphtml_after_home13']) OR $config['seo_uphtml_after_home13'] == 1): ?>checked="checked"<?php endif; ?> class="<?php if($global['web_cmsmode'] != 1): ?>grey<?php endif; ?>" <?php if($global['web_cmsmode'] != 1): ?>disabled="disabled"<?php endif; ?>>清除首页缓存</label>&nbsp;&nbsp;
                    <label class="curpoin <?php if($global['web_cmsmode'] != 1): ?>ey_auto_layer_tips grey<?php endif; ?>" data-layer_tips_txt='开启运营模式生效' data-layer_opt_tips='3'><input type="checkbox" name="seo_uphtml_after_channel13" value="1" <?php if(!isset($config['seo_uphtml_after_channel13']) OR $config['seo_uphtml_after_channel13'] == 1): ?>checked="checked"<?php endif; ?> class="<?php if($global['web_cmsmode'] != 1): ?>grey<?php endif; ?>" <?php if($global['web_cmsmode'] != 1): ?>disabled="disabled"<?php endif; ?>>清除相关栏目缓存</label>&nbsp;&nbsp;
                    <label class="curpoin <?php if($global['web_cmsmode'] != 1): ?>ey_auto_layer_tips grey<?php endif; ?>" data-layer_tips_txt='开启运营模式生效' data-layer_opt_tips='3'><input type="checkbox" name="seo_uphtml_after_pernext13" value="1" <?php if(!isset($config['seo_uphtml_after_pernext13']) OR $config['seo_uphtml_after_pernext13'] == 1): ?>checked="checked"<?php endif; ?> class="<?php if($global['web_cmsmode'] != 1): ?>grey<?php endif; ?>" <?php if($global['web_cmsmode'] != 1): ?>disabled="disabled"<?php endif; ?>>清除上下篇缓存</label>&nbsp;&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                    <input type="hidden" id="seo_uphtml_after_home13_old" value="<?php echo (isset($config['seo_uphtml_after_home13']) && ($config['seo_uphtml_after_home13'] !== '')?$config['seo_uphtml_after_home13']:''); ?>"/>
                    <input type="hidden" id="seo_uphtml_after_channel13_old" value="<?php echo (isset($config['seo_uphtml_after_channel13']) && ($config['seo_uphtml_after_channel13'] !== '')?$config['seo_uphtml_after_channel13']:''); ?>"/>
                    <input type="hidden" id="seo_uphtml_after_pernext13_old" value="<?php echo (isset($config['seo_uphtml_after_pernext13']) && ($config['seo_uphtml_after_pernext13'] !== '')?$config['seo_uphtml_after_pernext13']:''); ?>"/>
                </dd>
            </dl>
            ...
            <dl class="row none" id="dl_seo_force_inlet">
                <dt class="tit">
                    <label for="site_url">去除index.php</label>
                </dt>
                <dd class="opt">
                    <div class="onoff">
            ...
            <div class="bot">
                ...
                <input type="hidden" id="seo_uphtml_editafter_home_old" value="<?php echo (isset($config['seo_uphtml_editafter_home']) && ($config['seo_uphtml_editafter_home'] !== '')?$config['seo_uphtml_editafter_home']:''); ?>"/>
                <input type="hidden" id="seo_uphtml_editafter_channel_old" value="<?php echo (isset($config['seo_uphtml_editafter_channel']) && ($config['seo_uphtml_editafter_channel'] !== '')?$config['seo_uphtml_editafter_channel']:''); ?>"/>
                <input type="hidden" id="seo_uphtml_editafter_pernext_old" value="<?php echo (isset($config['seo_uphtml_editafter_pernext']) && ($config['seo_uphtml_editafter_pernext'] !== '')?$config['seo_uphtml_editafter_pernext']:''); ?>"/>
...
<script type="text/javascript">
    ...
    function change_html_confdata()
    {
        ...
        if (seo_pseudo == 2) {
            ...
            if (0 == is_change_data) {
                var seo_uphtml_editafter_home_old = $('#seo_uphtml_editafter_home_old').val();
                if (0 == seo_uphtml_editafter_home_old) {
                    seo_uphtml_editafter_home_old = undefined;
                }
                var seo_uphtml_editafter_home = $('input[name=seo_uphtml_editafter_home]:checked').val();
                if (seo_uphtml_editafter_home_old != seo_uphtml_editafter_home) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
            ...
            if (0 == is_change_data) {
                var seo_uphtml_editafter_channel_old = $('#seo_uphtml_editafter_channel_old').val();
                if (0 == seo_uphtml_editafter_channel_old) {
                    seo_uphtml_editafter_channel_old = undefined;
                }
                var seo_uphtml_editafter_channel = $('input[name=seo_uphtml_editafter_channel]:checked').val();
                if (seo_uphtml_editafter_channel_old != seo_uphtml_editafter_channel) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
            ...
            if (0 == is_change_data) {
                var seo_uphtml_editafter_pernext_old = $('#seo_uphtml_editafter_pernext_old').val();
                if (0 == seo_uphtml_editafter_pernext_old) {
                    seo_uphtml_editafter_pernext_old = undefined;
                }
                var seo_uphtml_editafter_pernext = $('input[name=seo_uphtml_editafter_pernext]:checked').val();
                if (seo_uphtml_editafter_pernext_old != seo_uphtml_editafter_pernext) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
            ...
            if (0 == is_change_data) {
                var seo_uphtml_after_home13_old = $('#seo_uphtml_after_home13_old').val();
                if (0 == seo_uphtml_after_home13_old) {
                    seo_uphtml_after_home13_old = undefined;
                }
                var seo_uphtml_after_home13 = $('input[name=seo_uphtml_after_home13]:checked').val();
                if (seo_uphtml_after_home13_old != seo_uphtml_after_home13) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
            ...
            if (0 == is_change_data) {
                var seo_uphtml_after_channel13_old = $('#seo_uphtml_after_channel13_old').val();
                if (0 == seo_uphtml_after_channel13_old) {
                    seo_uphtml_after_channel13_old = undefined;
                }
                var seo_uphtml_after_channel13 = $('input[name=seo_uphtml_after_channel13]:checked').val();
                if (seo_uphtml_after_channel13_old != seo_uphtml_after_channel13) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
            ...
            if (0 == is_change_data) {
                var seo_uphtml_after_pernext13_old = $('#seo_uphtml_after_pernext13_old').val();
                if (0 == seo_uphtml_after_pernext13_old) {
                    seo_uphtml_after_pernext13_old = undefined;
                }
                var seo_uphtml_after_pernext13 = $('input[name=seo_uphtml_after_pernext13]:checked').val();
                if (seo_uphtml_after_pernext13_old != seo_uphtml_after_pernext13) {
                    is_change_data = 1;
                } else {
                    is_change_data = 0;
                }
    ...
    $(function(){
        ...
        // 发布文档后，更新哪些页面
        $('input[name=seo_uphtml_after_home],input[name=seo_uphtml_after_channel],input[name=seo_uphtml_after_pernext],input[name=seo_uphtml_editafter_home],input[name=seo_uphtml_editafter_channel],input[name=seo_uphtml_editafter_pernext],input[name=seo_uphtml_after_home13],input[name=seo_uphtml_after_channel13],input[name=seo_uphtml_after_pernext13]').click(function(){
            // 静态模式下，是否改变任意一项配置
            change_html_confdata();
        });
        ...
        $('input[name="seo_force_inlet"]').click(function(){
            if (1 == $(this).val()) {
                layer.open({
                    ...
                    closeBtn: 0,
                    shadeClose: true,
                    content: '//<?php echo $website_host; ?>/api/Rewrite/testing.html',
