		...
		<div class="right_cont">
			<div class="news clearboth">
				...
				<div class="subBox clearboth">
					<span class="time"><?php echo MyDate('Y-m-d H:i:s',$eyou['field']['add_time']); ?></span>
					<div class="bdsharebuttonbox newsRight"></div>
				</div>
				<div class="job">
							<ul class="clearboth">
									<li class="clearboth">
											<img src="/template/old/images/recruit/icon1.jpg" />
											<div>
													<span>
															<em>招聘职位</em>
															<span>
									...
									<li class="clearboth">
											<img src="/template/old/images/recruit/icon2.jpg" />
											<div>
													<span>
															<em>人数</em>
															<span>
																<?php echo $eyou['field']['zprs']; ?>
															</span>
													</span>
											</div>
									</li>
									<li class="clearboth">
											<img src="/template/old/images/recruit/icon3.jpg" />
											<div>
													<span>
															<em>地点</em>
															<span>
																<?php echo $eyou['field']['gzdd']; ?>
															</span>
													</span>
											</div>
									</li>
									<li class="clearboth">
											<img src="/template/old/images/recruit/icon4.jpg" />
											<div>
													<span>
															<em>薪资待遇</em>
															<span>
																<?php echo $eyou['field']['xzdy']; ?>
															</span>
													</span>
											</div>
									</li>
			...
			<div class="page_box">
				...
				<a class=font_hei href="<?php echo $field['arcurl']; ?>"><?php echo $field['title']; ?></a>
				<?php else: ?>
				<a class=font_hei>上一篇：没有了</a>
				...
				<a href="{content:nextlink}" class="back"><?php echo $field['title']; ?></a>
				<?php else: ?>
				<a class="back">下一篇：没有了</a>
				<?php endif; $field = []; ?>
			</div>
		</div>
	</div>
