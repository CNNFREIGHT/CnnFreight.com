<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"./application/admin/template/arctype/single_edit.htm";i:1722214260;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756879123;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:77:"/www/wwwroot/cnnfreight.com/application/admin/template/field/addonextitem.htm";i:1756879123;s:85:"/www/wwwroot/cnnfreight.com/application/admin/template/diy_extend/archives_extend.htm";i:1571728724;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<?php if($editor['editor_select'] == '1'): ?>
    <script type="text/javascript" src="/public/plugins/Ueditor/ueditor.config.js?t=v1.7.6"></script>
    <script type="text/javascript" src="/public/plugins/Ueditor/ueditor.all.min.js?t=v1.7.6"></script>
    <script type="text/javascript" src="/public/plugins/Ueditor/lang/zh-cn/zh-cn.js?t=v1.7.6"></script>
<?php else: ?>
    <script type="text/javascript" src="/public/plugins/ckeditor/ckeditor.js?t=v1.7.6"></script>
<?php endif; ?>
...
<?php if(is_array($addonFieldExtList) || $addonFieldExtList instanceof \think\Collection || $addonFieldExtList instanceof \think\Paginator): $i = 0; $__LIST__ = $addonFieldExtList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if((('Custom' == $controller_name && isset($vo['ifeditable']) && $vo['ifeditable'] == 1) || ('Custom' != $controller_name && (!isset($vo['ifeditable']) || $vo['ifeditable'])))): switch($vo['dtype']): case "hidden": ?>
            ...
            <?php break; case "checkbox": ?>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <?php if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
                        <label><input type="checkbox" name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>][]" value="<?php echo $v2; ?>" <?php if(isset($vo['trueValue']) AND in_array($v2, $vo['trueValue'])): ?>checked="checked"<?php endif; ?> onclick="func_<?php echo $vo['name']; ?>_eyempty(this);"><?php echo $v2; ?></label>&nbsp;
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <script type="text/javascript">
                    function func_<?php echo $vo['name']; ?>_eyempty(obj)
                    {
            ...
            <?php break; case "checkboxs": ?>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <?php if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
                        <label><input type="checkbox" name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>][]" value="<?php echo $v2['id']; ?>" <?php if(isset($vo['trueValue']) AND in_array($v2, $vo['trueValue'])): ?>checked="checked"<?php endif; ?> onclick="func_<?php echo $vo['name']; ?>_eyempty(this);"><?php echo $v2['name']; ?></label>&nbsp;
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <input type="hidden" name="<?php echo $vo['fieldArr']; ?>[<?php echo $vo['name']; ?>_eyempty]" value="<?php if(!empty($vo['trueValue'])): ?>1<?php else: ?>0<?php endif; ?>">
                        <span class="err"></span>
                        <p class="notic"><?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:''); ?></p>
            ...
            <?php break; case "radios": ?>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <?php if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
                        <label><input type="radio" id="<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>" name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>]" value="<?php echo $v2['id']; ?>" <?php if(isset($vo['trueValue']) AND in_array($v2, $vo['trueValue'])): ?>checked="checked"<?php endif; ?>><?php echo $v2['name']; ?></label>&nbsp;
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <span class="err"></span>
                        <p class="notic"><?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:''); ?></p>
                    </dd>
            ...
            <?php break; case "selects": ?>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <select name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>]" id="<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>">
                            <?php if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $v2['id']; ?>" <?php if(isset($vo['trueValue']) AND in_array($v2, $vo['trueValue'])): ?>selected<?php endif; ?>><?php echo $v2['name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <span class="err"></span>
                        <p class="notic"><?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:''); ?></p>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show div_<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_eyou_local" <?php if($vo[$vo['name'].'_eyou_is_remote'] != '0'): ?>style="display: none;"<?php endif; ?>>
                        ...
                        <span class="type-file-box">
                            <input type="text" id="<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_eyou_local" name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_eyou_local]" value="<?php echo (isset($vo[$vo['name'].'_eyou_local']) && ($vo[$vo['name'].'_eyou_local'] !== '')?$vo[$vo['name'].'_eyou_local']:''); ?>" class="type-file-text" autocomplete="off">
                            <input type="hidden" id="<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_filename" name="<?php echo $vo['fieldArr']; ?>[<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_filename]" value="<?php echo (isset($vo[$vo['name'].'_filename']) && ($vo[$vo['name'].'_filename'] !== '')?$vo[$vo['name'].'_filename']:''); ?>" autocomplete="off">
            ...
            <script type="text/javascript">
                function upload_file_<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_1585641737(e){
                    ...
                    if ('qny' == data_type) {
                        ...
                        // 亚马逊S3上传
                        <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_file(e);
                    } else {
                        // 本地上传
                ...
                function <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_qny_file(e) {
                    ...
                    // 验证上传格式
                    var fileName = org_filename = file.name;
                            ...
                            if (1 == res1.code) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(res2) {
                                        ...
                                        $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_filename").val(org_filename);
                ...
                //亚马逊S3
                function <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_file(e) {
                    // 获取文件路径名
                    var file = $(e)[0].files[0];
                        ...
                        xhr: function () {
                            ...
                            if (myXhr.upload) {
                                myXhr.upload.addEventListener('progress', function(e){
                                    ...
                                    $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media").text('上传中...'+process+"%");
                                });
                            }
                            return myXhr;
                        },
                                            ...
                                            <div class="images_upload images_upload_html" style="display:inline-block;">
                                                <div class="images_upload_box">
                                                    ...
                                                    <a href="<?php echo $v2['image_url']; ?>" onclick="" class="upimg" target="_blank" title="拖动修改排序">
                                                        <img data-original="<?php echo $v2['image_url']; ?>">
                                                    </a>
            ...
            <?php break; case "htmltext": ?>
                <!-- HTML文本 start -->
                <?php if(empty($AiEditorConfig['openEditor']) || (($AiEditorConfig['openEditor'] instanceof \think\Collection || $AiEditorConfig['openEditor'] instanceof \think\Paginator ) && $AiEditorConfig['openEditor']->isEmpty())): if($editor['editor_select'] == '1'): ?>
                        <dl class="row">
                            <dt class="tit">
                                <label><?php if(isset($vo['ifrequire']) AND !empty($vo['ifrequire'])): ?><em>*</em><?php endif; ?><?php echo (isset($vo['title']) && ($vo['title'] !== '')?$vo['title']:''); ?></label>
                            </dt>
                        ...
                        <dl class="row">
                            ...
                            <dd class="opt">
                                ...
                                <?php if(!in_array($vo['name'], ['content','content_ey_m'])): ?>
                                <span class="err"></span>
                                <p class="notic"><?php echo (isset($vo['remark']) && ($vo['remark'] !== '')?$vo['remark']:''); ?></p>
                                <?php endif; ?>
                            </dd>
                        ...
                        <?php endif; endif; else: if(file_exists(ROOT_PATH.'weapp/AiEditor/template/ai_editor.htm')): ?>
                        模板文件不存在: ./weapp/AiEditor/template/ai_editor.htm
                    <?php endif; endif; ?>
                <!-- HTML文本 end -->
            <?php break; ?>
            ...
            <?php case "media": ?>
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <?php elseif('aws' == $vo['upload_flag']): ?>
                        <button type="button" class="layui-btn" id="<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media" onclick="$('#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_upload_media').attr('data-type', 'aws').trigger('click');">亚马逊S3上传</button>
                        <?php else: ?>
                ...
                <script>
                    ...
                    function <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_upload_media_20210408(e){
                        ...
                        if ('qny' == data_type) {
                            ...
                            // 亚马逊S3上传
                            <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media(e);
                        } else {
                            // 本地上传
                    ...
                    //亚马逊S3
                    function <?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media(e) {
                        // 获取文件路径名
                        var file = $(e)[0].files[0];
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                layer.closeAll();
                                if (1 == res.code) {
                                    $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media").text('上传成功');
                                    $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_media_url").val(res.data.url);
                                } else {
                                    $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media").text('上传失败');
                                }
                                setTimeout(function() {
                                    $('#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_aws_upload_media').text('cos上传');
                                }, 2000);
                            },
                            error: function(e) {
                                layer.closeAll();
                            ...
                            xhr: function () {
                                ...
                                if (myXhr.upload) {
                                    myXhr.upload.addEventListener('progress', function(e){
                                        ...
                                        var total = e.total;
                                        process = parseInt(curr / total * 100);
                                        $("#<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>_local_upload_media").html('上传中...'+process+"%");
                                    });
                                }
                                return myXhr;
                            },
...
<script type="text/javascript">
    ...
    $(function(){
        try {
            $("img").lazyload({
                effect: "fadeIn",
                placeholder : "/public/static/common/images/loading.gif",
                threshold: 200
            });
        }catch(e){}
        ...
        */
        ...
        if (0 == notic_tips_230112) {
            ...
            var ganhaohtml = '<a href="<?php echo url('Field/channel_index', ['channel_id'=>$vo['channel_id']]); ?>">[字段管理]</a>';
        ...
        <div class="ncap-form-default">
            <div class="bot2">
                <input type="hidden" name="archives" value="<?php echo (isset($archives) && ($archives !== '')?$archives:0); ?>">
                ...
                <input type="hidden" name="editor_addonFieldExt" id="editor_addonFieldExt" value="<?php echo (isset($editor_addonFieldExt) && ($editor_addonFieldExt !== '')?$editor_addonFieldExt:''); ?>">
