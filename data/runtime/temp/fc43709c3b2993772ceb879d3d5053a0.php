<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:48:"./application/admin/template/system/api_conf.htm";i:1692667950;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756879123;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:69:"/www/wwwroot/cnnfreight.com/application/admin/template/system/bar.htm";i:1667356242;s:78:"/www/wwwroot/cnnfreight.com/application/admin/template/system/pay_api_list.htm";i:1692667950;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/system/notify.htm";i:1741228788;s:76:"/www/wwwroot/cnnfreight.com/application/admin/template/system/canal_list.htm";i:1686877574;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="plug-list">
    ...
    <div class="plug-item-content">
        <div class="plug-item-top">
            <div class="plug-img">
                <a <?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>href="JavaScript:showErrorAlert('该功能仅限于授权域名使用！', 4);"<?php else: ?>href="<?php echo url('System/sms'); ?>"<?php endif; ?>><img src="/public/static/admin/images/sms.png?v=<?php echo $version; ?>"></a>
            </div>
            <div class="plug-text">
                <div class="plug-text-title">
                    <a <?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>href="JavaScript:showErrorAlert('该功能仅限于授权域名使用！', 4);"<?php else: ?>href="<?php echo url('System/sms'); ?>"<?php endif; ?>>云短信
                        <?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>
                            <i class="anchor-icon anchor-icon-biao" title="限授权域名使用"></i>
                        <?php endif; ?>
                    </a>
                </div>
                <div class="plug-text-versions">
        ...
        <div class="plug-item-bottm">
            <a <?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>href="JavaScript:showErrorAlert('该功能仅限于授权域名使用！', 4);"<?php else: ?>href="<?php echo url('System/sms'); ?>"<?php endif; ?>>配置</a>
        </div>
    </div>
    <!-- 站内信通知 -->
