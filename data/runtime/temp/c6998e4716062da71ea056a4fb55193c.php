  ...
  <div class="all">
    ...
    <div class="all">
      ...
      <div class="news_cont clearboth">
        <div class="Left">
          <?php if(\think\Cookie::get('home_lang') =='cn'):  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(isset($ui_modelid) && !empty($ui_modelid)) : $modelid = $ui_modelid; else: $modelid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 100; endif; $tagChannel = new \think\template\taglib\eyou\TagChannel; $_result = $tagChannel->getChannel($typeid, "sonself", "cur", "", $modelid); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $field["typename"] = text_msubstr($field["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $field;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
    ...
    <?php endif; ?>
          ...
          <div class="list">
            <ul>
              ...
              <li class="clearboth">
                <div class="imgbox"><img src="<?php echo $field['litpic']; ?>" /></div>
                <div class="text">
                  <h3><a href="<?php echo $field['arcurl']; ?>"><?php echo $field['title']; ?></a></h3>
                  <p><?php echo $field['seo_description']; ?></p>
                  <div class="Text_r"><a href="<?php echo $field['arcurl']; ?>">More</a></div>
                </div>
              </li>
