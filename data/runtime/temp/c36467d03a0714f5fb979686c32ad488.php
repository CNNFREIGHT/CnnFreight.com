<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"./application/admin/template/vertify/admin_login.htm";i:1721637128;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756433208;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:70:"/www/wwwroot/cnnfreight.com/application/admin/template/vertify/bar.htm";i:1655708908;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page min-hg-c-10">
    ...
    <div class="item-title">
        ...
        <ul class="tab-base nc-row">
            <li>
                <a href="<?php echo url('Vertify/index', ['inc_type'=>'admin_login']); ?>" class="tab <?php if($inc_type == 'admin_login'): ?>current<?php endif; ?>"><span>后台登录</span></a>
            </li>
            <?php if(!empty($global['web_users_switch'])): ?>
            <li>
                <a href="<?php echo url('Vertify/index', ['inc_type'=>'users_reg']); ?>" class="tab <?php if($inc_type == 'users_reg'): ?>current<?php endif; ?>"><span>会员注册</span></a>
            </li>
            <li>
                <a href="<?php echo url('Vertify/index', ['inc_type'=>'users_login']); ?>" class="tab <?php if($inc_type == 'users_login'): ?>current<?php endif; ?>"><span>会员登录</span></a>
            </li>
            <li>
                <a href="<?php echo url('Vertify/index', ['inc_type'=>'users_retrieve_password']); ?>" class="tab <?php if($inc_type == 'users_retrieve_password'): ?>current<?php endif; ?>"><span>找回密码</span></a>
            </li>
            <?php endif; ?>
            <li>
                <a href="<?php echo url('Vertify/index', ['inc_type'=>'guestbook']); ?>" class="tab <?php if($inc_type == 'guestbook'): ?>current<?php endif; ?>"><span>留言模型</span></a>
            </li>
        </ul>
    </div>
</div>
    <form class="form-horizontal" id="post_form" action="" method="post">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <label class="curpoin"><input id="admin_login_is_on1" name="captcha[admin_login][is_on]" value="1" type="radio" <?php if(!empty($row['is_on'])): ?>checked="checked"<?php endif; ?>>启用</label>
                    <label class="curpoin"><input id="admin_login_is_on0" name="captcha[admin_login][is_on]" value="0" type="radio" <?php if(empty($row['is_on'])): ?>checked="checked"<?php endif; ?>>关闭</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>            
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="captcha[admin_login][config][codeSet]" placeholder="验证码预置字符" value="<?php echo (isset($row['config']['codeSet']) && ($row['config']['codeSet'] !== '')?$row['config']['codeSet']:$row['default']['codeSet']); ?>" id="codeSet" class="input-txt" onkeyup="this.value=this.value.replace(/[^\w]/g,'');" onpaste="this.value=this.value.replace(/[^\w]/g,'')">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="captcha[admin_login][config][fontSize]" placeholder="验证码字体大小(px)" value="<?php echo (isset($row['config']['fontSize']) && ($row['config']['fontSize'] !== '')?$row['config']['fontSize']:$row['default']['fontSize']); ?>" id="fontSize" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <label class="curpoin"><input id="admin_login_useCurve1" name="captcha[admin_login][config][useCurve]" value="1" type="radio" <?php if($row['config']['useCurve'] == '1'): ?>checked="checked"<?php endif; ?>>开</label>
                    <label class="curpoin"><input id="admin_login_useCurve0" name="captcha[admin_login][config][useCurve]" value="0" type="radio" <?php if(empty($row['config']['useCurve'])): ?>checked="checked"<?php endif; ?>>关</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <label class="curpoin"><input id="admin_login_useNoise1" name="captcha[admin_login][config][useNoise]" value="1" type="radio" <?php if($row['config']['useNoise'] == '1'): ?>checked="checked"<?php endif; ?>>是</label>
                    <label class="curpoin"><input id="admin_login_useNoise0" name="captcha[admin_login][config][useNoise]" value="0" type="radio" <?php if(empty($row['config']['useNoise'])): ?>checked="checked"<?php endif; ?>>否</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="captcha[admin_login][config][length]" placeholder="验证码图片高度" value="<?php echo (isset($row['config']['length']) && ($row['config']['length'] !== '')?$row['config']['length']:$row['default']['length']); ?>" id="length" class="input-txt" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/\[^0-9]/g,''));">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <div class="bot">
                <input type="hidden" name="inc_type" id="inc_type" value="<?php echo (isset($inc_type) && ($inc_type !== '')?$inc_type:'default'); ?>">
