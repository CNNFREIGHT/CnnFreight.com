<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/weapp/mybuy.htm";i:1750816366;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756879123;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:68:"/www/wwwroot/cnnfreight.com/application/admin/template/weapp/bar.htm";i:1750816366;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="plug-item-content">
                    ...
                    <div class="plug-item-bottm">
                        <?php if(empty($vo['status']) || (($vo['status'] instanceof \think\Collection || $vo['status'] instanceof \think\Paginator ) && $vo['status']->isEmpty())): if(empty($vo['is_buy']) || (($vo['is_buy'] instanceof \think\Collection || $vo['is_buy'] instanceof \think\Paginator ) && $vo['is_buy']->isEmpty())): if(is_check_access('Weapp@install') == '1'): ?>
                                ...
                                <?php endif; ?>
                                <!-- <?php if(is_check_access('Weapp@del') == '1'): ?>
                                ...
                                <?php endif; ?> -->
                            <?php else: if(is_check_access('Weapp@install') == '1'): ?>
                                ...
                                <?php endif; ?>
                                <!-- <?php if(is_check_access('Weapp@del_remote') == '1'): ?>
                                ...
                                <?php endif; ?> -->
                            <?php endif; else: if(is_check_access('Weapp@execute') == '1'): if(empty($vo['config']['management']['href'])): ?>
