<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"./application/admin/template/archives/index_archives.htm";i:1756879123;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/layout.htm";i:1756879123;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;s:76:"/www/wwwroot/cnnfreight.com/application/admin/template/archives/tags_btn.htm";i:1713251000;s:70:"/www/wwwroot/cnnfreight.com/application/admin/template/public/page.htm";i:1655708908;s:72:"/www/wwwroot/cnnfreight.com/application/admin/template/public/footer.htm";i:1680508820;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page min-hg-c-66">
    <div class="flexigrid" style="margin-top: 0px;min-height: 600px;">
        <div class="mDiv"><div class="ftitle"><!-- 扩展 -->
    ...
    <script type="text/javascript">
        ...
        <div class="header-bar mb20">
            <div class="more">
                <div class="search">
                    <div class="content">
                        <form id="searchForm" action="<?php echo url('Archives/index_archives'); ?>" method="get" onsubmit="layer_loading('正在处理');" style="display: unset;">
                                ...
                                <div class="users-form-item-content">
                                    <div class="users-select">
                                        <div tabindex="0" class="users-select-selection">
                                            <div class="sDiv2">
                                                <input type="text" size="50" name="keywords" value="<?php echo \think\Request::instance()->param('keywords'); ?>" class="qsbox w220" placeholder="请输入文档标题/ID">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ey-form-item">
                                <label class="users-form-item-label">属性：</label>
                                <div class="users-form-item-content">
                                    <div class="users-select">
                                        <div tabindex="0" class="users-select-selection">
                                            <div>
                                                <select name="flags" id="flag">
                                                    ...
                                                    <option value="<?php echo $vo['flag_fieldname']; ?>" <?php if(\think\Request::instance()->param('flags') == $vo['flag_fieldname']): ?>selected<?php endif; ?>><?php echo $vo['flag_name']; ?></option>
                            ...
                            <div class="ey-form-item"><label class="users-form-item-label">发布时间：</label>
                                <div class="users-form-item-content">
                                    <div class="users-select">
                                        <div tabindex="0" class="users-select-selection">
                                            <div class="sDiv2">
                                                <input type="text" name="add_time" id="eYLaydateTimeLinkage" data-max_date="<?php echo date('Y-m-d'); ?>" autocomplete="off"  class="qsbox" placeholder="请选择" lay-key="1" style="width: 220px;" value="<?php echo \think\Request::instance()->param('add_time'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ey-form-item"><label class="users-form-item-label">区域：</label>
                                <div class="users-form-item-content">
                                    <div class="users-select">
                                        <div tabindex="0" class="users-select-selection">
                                            <div class="">
                                    ...
                                    <div class="users-select" style="display: none;" >
                                        <div tabindex="0" class="users-select-selection">
                                            <div class="">
                                                <select name="city_id" id="city_id" onchange="set_area_list(0);">
                                                    <option value="">--请选择--</option>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="ey-form-item" style="margin-left: 20px;">
                            <div class="users-form-item-content">
                                <span class="bt-xin" onclick="archivesQuery();">查询</span>
                                <span class="bt-xin-no" onclick="archivesQuery('reset');">重置</span>
                            </div>
                        </div>
                        <script type="text/javascript">
                            function archivesQuery(isReset) {
                                if (isReset && 'reset' == isReset) {
                                    window.location.href = "<?php echo url('Archives/index_archives'); ?>";
                                } else {
                                    $('#searchForm').submit();
                                }
                            }
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="tc w100">
                                    <?php echo (isset($vo['areas']) && ($vo['areas'] !== '')?$vo['areas']:''); ?>
                                </div>
                            </td>
                            <?php endif; ?>
        ...
        <div class="footer-oper">
            ...
            <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Archives/del'); ?>" <?php if($global['web_recycle_switch'] == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?> class="layui-btn layui-btn-primary" title="删除文档">删除文档</a>
            <?php endif; if(is_check_access('Archives@index_draft') == '1'): ?>
...
<!-- 日期联动选择js文件 start -->
<script type="text/javascript" src="/public/static/common/js/ey_laydate_time_linkage.js?v=<?php echo $version; ?>"></script>
<!-- 日期联动选择js文件 end -->
<div id="goTop">
