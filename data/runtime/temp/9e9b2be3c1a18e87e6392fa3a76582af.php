<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:34:"./template/old/pc/view_article.htm";i:1756433053;s:57:"/www/wwwroot/cnnfreight.com/template/old/pc/comm/head.htm";i:1756433056;s:56:"/www/wwwroot/cnnfreight.com/template/old/pc/comm/top.htm";i:1756433057;s:60:"/www/wwwroot/cnnfreight.com/template/old/pc/comm/sortnav.htm";i:1756433057;s:57:"/www/wwwroot/cnnfreight.com/template/old/pc/comm/foot.htm";i:1756433056;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="utf-8">
    ...
    <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; endif; ?>
			...
			<div class="right_cont">
				<div class="news clearboth">
					...
					<div class="subBox clearboth">
						<?php if(\think\Cookie::get('home_lang') =='cn'): ?>
						<span class="time">发布时间：<?php echo MyDate('Y-m-d',$eyou['field']['update_time']); ?></span>
						<?php elseif(\think\Cookie::get('home_lang') =='en'): ?>
						<span class="time">Release time：<?php echo MyDate('Y-m-d',$eyou['field']['update_time']); ?></span>
						<?php endif; ?>
						<div class="bdsharebuttonbox newsRight"></div>
					</div>
				...
				<div class="page_box">
					<?php if(\think\Cookie::get('home_lang') =='cn'):  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("pre");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?> <a class="font_hei" href="<?php echo $field['arcurl']; ?>">上一篇 : <?php echo $field['title']; ?></a><?php else: ?><a class="font_hei">上一篇：没有了</a><?php endif; $field = [];  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("next");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?><a class="font_hei" href="<?php echo $field['arcurl']; ?>">下一篇 : <?php echo $field['title']; ?></a><?php else: ?><a class="font_hei">下一篇：没有了</a><?php endif; $field = []; elseif(\think\Cookie::get('home_lang') =='en'):  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("pre");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?> <a class="font_hei" href="<?php echo $field['arcurl']; ?>">Previous article : <?php echo $field['title']; ?></a><?php else: ?><a class="font_hei">Previous article：NO</a><?php endif; $field = [];  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("next");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?><a class="font_hei" href="<?php echo $field['arcurl']; ?>">Next article : <?php echo $field['title']; ?></a><?php else: ?><a class="font_hei">Next article：NO</a><?php endif; $field = []; endif; ?>
				</div>
			</div>
		</div>
	</div>
