<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/template/index/switch_map.htm";i:1750816366;s:75:"/www/wwwroot/cnnfreight.com/application/admin/template/public/theme_css.htm";i:1721637128;}*/ ?>
<!doctype html>
<html>
<head>
...
<body class="bodystyle">
                                ...
                                <div class="on-off_btn">
                                    ...
                                    <div class="on-off_btn_r">
                                        <input type="checkbox" name="users[users_open_release]" lay-skin="switch" lay-text="开启|关闭" lay-filter="switchTest"
                                               data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" <?php if($usersConfig['users_open_release'] == '1'): ?>checked="" <?php endif; ?>
                                               data-type="users" data-name="users_open_release" data-lmenuid="Archives_index_draft" value="<?php echo $usersConfig['users_open_release']; ?>">
                                    </div>
                                </div>
                            </li>
                            <li class="more_li">
                                <div class="on-off_btn">
                                    ...
                                    <div class="on-off_btn_r">
                                        <input type="checkbox" name="level[level_member_upgrade]" lay-skin="switch" lay-text="开启|关闭" lay-filter="switchTest"
                                               data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" <?php if($usersConfig['level_member_upgrade'] == '1'): ?>checked="" <?php endif; ?>
                                        data-type="level" data-name="level_member_upgrade" data-lmenuid="off" value="<?php echo $usersConfig['level_member_upgrade']; ?>">
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="on-off_btn">
                                    ...
                                    <div class="on-off_btn_r">
                                        <input type="checkbox" name="shop[shop_open]" lay-skin="switch" lay-text="开启|关闭" lay-filter="switchTest"
                                               data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" <?php if($usersConfig['shop_open'] == '1'): ?>checked="" <?php endif; ?>
                                        data-type="shop" data-name="shop_open" data-lmenuid="Shop_home" value="<?php echo $usersConfig['shop_open']; ?>">
                                    </div>
                                </div>
                            </li>
                            ...
                            <div class="on-off_btn">
                                ...
                                <div class="on-off_btn_r">
                                    <input type="checkbox" name="pay[pay_open]" lay-skin="switch" lay-text="开启|关闭" lay-filter="switchTest"
                                           data-authortoken="<?php echo $is_eyou_authortoken; ?>" data-is_online="<?php echo $is_online; ?>" <?php if($usersConfig['pay_open'] == '1'): ?>checked="" <?php endif; ?>
                                    data-type="pay" data-name="pay_open" data-lmenuid="off" value="<?php echo $usersConfig['pay_open']; ?>">
        ...
        <div class="on-off_panel" >
             <div class="on-off_list_bg bg-fff" id="wendangxiagnguan" style="display: block;">
                 ...
                 <div class="on-off_list" id="wendangxiagnguan_child" style="display: block;">
                     <ul class="flex-dir-row  flex-wrap">
                        <?php if(is_array($menuGroupList[1]) || $menuGroupList[1] instanceof \think\Collection || $menuGroupList[1] instanceof \think\Paginator): $i = 0; $__LIST__ = $menuGroupList[1];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(1 == $vo['opt_access']): ?>
                                 <li class="more_li" id="li_<?php echo $vo['menu_id']; ?>" <?php if(in_array($vo['menu_id'], $admin_menu_id_arr) || in_array($vo['menu_id'], $not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                     <div class="flex-dir-row flex-a-center">
                                         <div class="icon_bg icon_bg_no">
                                             <i class="f-20 col-848484 <?php echo $vo['litpic']; ?>" ></i>
                                         </div>
                                         <div class="ml-8">
                                             <a href="javascript:void(0);" data-href="<?php echo $vo['href']; ?>"  onclick="gourl2(this,1);"><?php echo $vo['title']; ?></a>
                                         </div>
                                     </div>
                                    <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                     <div class="icon-link_add">
                                         <div title="加入导航显示" data-menu_id="<?php echo $vo['menu_id']; ?>" class="iconfont e-jiahao2"></div>
                                     </div>
                                    <?php endif; ?>
                                 </li>
             ...
             <div class="on-off_list_bg bg-fff" id="gaojixuanxiang" style="display: block;">
                 ...
                 <div class="on-off_list" id="gaojixuanxiang_child" style="display: block;">
                     <ul class="flex-dir-row  flex-wrap">
                        <?php if(is_array($menuGroupList[2]) || $menuGroupList[2] instanceof \think\Collection || $menuGroupList[2] instanceof \think\Paginator): $i = 0; $__LIST__ = $menuGroupList[2];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(1 == $vo['opt_access']): ?>
                                 <li class="more_li" id="li_<?php echo $vo['menu_id']; ?>" <?php if(in_array($vo['menu_id'], $admin_menu_id_arr) || in_array($vo['menu_id'], $not_role_menu_id_arr) || empty($vo['show_status'])): ?>style="display:none"<?php endif; ?>>
                                     <div class="flex-dir-row flex-a-center">
                                         <div class="icon_bg icon_bg_no">
                                             <i class="f-20 col-848484 <?php echo $vo['litpic']; ?>" ></i>
                                         </div>
            ...
            <div class="on-off_list_bg bg-fff" id="shangchengmokuai" style="display: block;">
                ...
                <div class="on-off_list" id="shangchengmokuai_child" style="display: block;">
                    <ul class="flex-dir-row  flex-wrap">
                        <?php if(is_array($menuGroupList[3]) || $menuGroupList[3] instanceof \think\Collection || $menuGroupList[3] instanceof \think\Paginator): $i = 0; $__LIST__ = $menuGroupList[3];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(1 == $vo['opt_access']): ?>
                                 <li class="more_li" id="li_<?php echo $vo['menu_id']; ?>" <?php if(in_array($vo['menu_id'], $admin_menu_id_arr) || in_array($vo['menu_id'], $not_role_menu_id_arr) || empty($vo['show_status'])): ?>style="display:none"<?php endif; ?>>
                                     <div class="flex-dir-row flex-a-center">
                                         <div class="icon_bg icon_bg_no">
                                             <i class="f-20 col-848484 <?php echo $vo['litpic']; ?>" ></i>
            ...
            <div class="on-off_list_bg bg-fff" id="seomokuai" style="display: block;">
                 ...
                 <div class="on-off_list" id="seomokuai_child" style="display: block;">
                     <ul class="flex-dir-row  flex-wrap">
                        <?php if(is_array($menuGroupList[4]) || $menuGroupList[4] instanceof \think\Collection || $menuGroupList[4] instanceof \think\Paginator): $i = 0; $__LIST__ = $menuGroupList[4];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(1 == $vo['opt_access']): ?>
                                 <li class="more_li" id="li_<?php echo $vo['menu_id']; ?>" <?php if(in_array($vo['menu_id'], $admin_menu_id_arr) || in_array($vo['menu_id'], $not_role_menu_id_arr) || empty($vo['show_status'])): ?>style="display:none"<?php endif; ?>>
                                     <div class="flex-dir-row flex-a-center">
                                         <div class="icon_bg icon_bg_no">
                                             <i class="f-20 col-848484 <?php echo $vo['litpic']; ?>" ></i>
    ...
    <script type="text/javascript">
        ...
        var is_founder = <?php echo (isset($is_founder) && ($is_founder !== '')?$is_founder:0); ?>;
...
//                $(this).toggleClass("e-jianhao");
        ...
        */
        function hide_module_menu(name) {
            for(var i=0;i<name.length;i++){
                var rele_menu = [];
                if (!module_rele_menu[name[i]+'-close'] === false) {
                    rele_menu = module_rele_menu[name[i]+'-close'];
                } else {
                    rele_menu = module_rele_menu[name[i]];
                }
                if (rele_menu){
                    for (var j=0;j<rele_menu.length;j++){
