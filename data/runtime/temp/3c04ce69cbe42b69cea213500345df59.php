...
<div class="subTitle">
  ...
  <div class="navbar">
    ...
    <?php endif; ?>
          ...
          <div class="messageBox clearboth">

            <div>

              <img src="/template/old/images/contact/icon.jpg">

              <span>
                <?php if(\think\Cookie::get('home_lang') =='cn'): ?>
                如果您有任何问题要咨询我们，欢迎您随时给我们留言， 我们将及时回复您！
                <?php elseif(\think\Cookie::get('home_lang') =='en'): ?>
                If you have any questions, please leave us a message at any time and we will reply to you in time!
                <?php endif; ?>
              </span>

            </div>

            <img src="/template/old/images/contact/people.jpg">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-6">
               ...
               <?php  $typeid = "0"; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default", "", 0); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                  ...
                  <form method="POST" action="<?php echo $field['action']; ?>"  <?php echo $field['formhidden']; ?> onsubmit="<?php echo $field['submit']; ?>" class="my-4" onsubmit="return submsg(this);">
                        ...
                        <div class="form-group">
                            ...
                            <li>
                                ...
                                <input type="text" name="<?php echo $field['attr_30']; ?>" required id="contacts" class="form-control" placeholder="<?php echo $field['itemname_30']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <li>
                                ...
                                <input type="text" name="<?php echo $field['attr_31']; ?>" required id="mobile" class="form-control" placeholder="<?php echo $field['itemname_31']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <li>
                                ...
                                <textarea  cols="20" rows="2" name="<?php echo $field['attr_32']; ?>" id="content" class="form-control" placeholder="<?php echo $field['itemname_32']; ?>"></textarea>
                        ...
                        <div class="form-group">
                          ...
                          <button type="submit" class="btn btn-info mb-2 submit">提交留言</button>
