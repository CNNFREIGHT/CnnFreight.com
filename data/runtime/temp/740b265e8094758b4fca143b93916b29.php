...
<div class="nav">
  <div class="all">
	...
	<div class="all">
  	<div class="cooperate_cont clearboth">
			<div class="Left">
				<!-- 二级栏目导航 -->
...
<div class="subTitle">
  ...
  <div class="navbar">
    ...
    <?php endif; ?>
				...
				<div style="text-align:center;margin-bottom:100px; margin-top:0px;line-height:30px;font-size:14px;color:#999999;font-family:微软雅黑;">
					<table cellSpacing=0 cellPadding=0 width=100%align=center border=0>
									<table bordercolor=#ededed cellspacing=0 cellpadding=8 width=100%border=0>
											<tr>
												<td bgcolor="#F2F2F2" colspan=4 height="30" valign="middle">
													<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
														<tr>
															<td width="34%"><div align="center">职位名称</div></td>
															<td width="20%"><div align="center">招聘人数</div></td>
															<td width="27%"><div align="center">工作地点</div></td>
															<td width="19%"><div align="center">薪资</div></td>
														</tr>
													</table>
												</td>
											</tr>
											<?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $modelid = "";  if(empty($modelid) && isset($channelartlist["current_channel"]) && !empty($channelartlist["current_channel"])) : $modelid = intval($channelartlist["current_channel"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "keyword"=> "",      "idlist"=> "",      "idrange"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 10, "", "", "desc", "on","off","");if(!empty($_result_tmp) && (is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 100, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
											
											<tr>
												<td width="34%" height="30" align="center" style="border-right:1px solid #E3E3E3;border-bottom:1px solid #E3E3E3;border-left:1px solid #E3E3E3;">
													<div align="left" style="padding-left:10px">
														<a href="<?php echo $field['arcurl']; ?>" title="查看详情>>">
															<?php echo $field['title']; ?>
														</a>
													</div>
												</td>
												<td width="20%" style="border-right:1px solid #E3E3E3;border-bottom:1px solid #E3E3E3;">
													<div align="center">
														<?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("zprs", $aid); echo $__VALUE__; unset($aid); ?>
													</div>
												</td>
												<td width="26%" align="center" style="border-right:1px solid #E3E3E3;border-bottom:1px solid #E3E3E3;">
													<div align="left" style="padding-left:10px">
														<?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("gzdd", $aid); echo $__VALUE__; unset($aid); ?>
													</div>
												</td>
												<td width="20%" style="border-right:1px solid #E3E3E3;border-bottom:1px solid #E3E3E3;">
													<div align="center">
														<?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("xzdy", $aid); echo $__VALUE__; unset($aid); ?>
													</div>
												</td>
											</tr>
