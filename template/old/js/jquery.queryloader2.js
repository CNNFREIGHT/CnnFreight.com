...
OverlayLoader.prototype.createOverlay = function () {
	...
	this.loadPic = $("<div id='loading'></div>").css({
		height: "10rem",
		width: "30%",
		position: "absolute",
		fontSize: "2.3em",
	...
	if (this.parent.options.percentage == true) {
		this.percentageContainer = $("<div id='qLpercentage' style='color:#fff;'></div>").text("0%").css({
			height: "50px",
			width: "50px",
			position: "absolute",
			fontSize: "2.3em",
...
OverlayLoader.prototype.updatePercentage = function (percentage) {
	...
	if (this.parent.options.percentage == true) {
		...
		// this.percentageContainer.height((Math.ceil(percentage)/100)*11+"rem");
		this.loadPic.height((Math.ceil(percentage)/100)*11+"rem");		
	}
};
