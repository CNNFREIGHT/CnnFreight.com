...
<main>
  <div id="caselist">
    {pboot:list num=5 order=sorting}
    <article class="caseitem wow animate__fadeInUp">
      <div class="inner">
        <figure class="figure"> <a href="[list:link]" title="[list:title]"> <img src="[list:ico]" alt="[list:title]"> </a> </figure>
        <div class="text">
          <h2 class="title"><a href="[list:link]" title="[list:title]">[list:title]</a></h2>
          <div class="rows excerpt">[list:description lencn=110]</div>
        </div>
      </div>
    </article>
    {/pboot:list}
