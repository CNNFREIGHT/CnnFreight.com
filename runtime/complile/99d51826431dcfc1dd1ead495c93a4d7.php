    ...
    <main id="main">
      <div id="blogList">
        ...
        <article class="blogItem wow animate__fadeInUp">
          <figure class="thumbnail"> <a target="_blank" href="[list:link]" title="[list:title]"> <img src="[list:ico]" alt="[list:title]"> </a> </figure>
          <div class="text">
            <h2 class="title"> <a target="_blank" href="[list:link]" title="[list:title]">[list:title]</a> </h2>
            <div class="rows excerpt"> [list:description lencn=120] </div>
            <div class="meta"> <span> <i class="ri-calendar-check-line"></i>
              <time datetime="[list:date style=Y-m-d]">[list:date style=Y-m-d]</time>
              </span> <span> <a href="[list:sortlink]" title="[list:sortname]"><i class="ri-price-tag-3-line"></i> [list:sortname]</a> </span> <span><i class="ri-eye-line"></i> [list:visits]</span></div>
          </div>
        </article>
        {/pboot:list}
      </div>
